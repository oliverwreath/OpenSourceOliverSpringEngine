...
INSERT INTO `authorities` (`id`, `authority`, `created_by`, `created_on`, `updated_by`, `updated_on`, `user_id`) VALUES (1,'ROLE_ADMIN',NULL,NULL,NULL,NULL,1),(2,'ROLE_ADMIN',NULL,NULL,NULL,NULL,1),(3,'ROLE_USER',NULL,NULL,NULL,NULL,1);
...
INSERT INTO `drop_down_list_entities` (`id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `my_values`) VALUES ('CATALOG',NULL,NULL,NULL,NULL,'四大_BIG4, 咨询_CONSULTING, 大数据_BIG_DATA, FLAG, 金融_FINANCE, 快消_CPG'),('COUNTRY',NULL,NULL,NULL,NULL,'USA, Canada, Australia, New Zealand, China, Japan, Korea, U.K., Germany, Switzerland, France, Spain, Italy, OtherEuropeAmerica, Other AsiaPacific, Other');
...
INSERT INTO `users` (`id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `enabled`, `password`, `user_email`, `user_type`) VALUES (1,NULL,NULL,NULL,NULL,_binary '','$2a$10$E7z3fBbyHZtqLYre4S9D/uGc8Nhf6S2NnvVkT3lDMMeNkCXc/u2Gu','admin@gmail.com',NULL),(2,NULL,NULL,NULL,NULL,_binary '','$2a$10$E7z3fBbyHZtqLYre4S9D/uGc8Nhf6S2NnvVkT3lDMMeNkCXc/u2Gu','admin@example.com',NULL),(3,NULL,NULL,NULL,NULL,_binary '','$2a$10$E7z3fBbyHZtqLYre4S9D/uGc8Nhf6S2NnvVkT3lDMMeNkCXc/u2Gu','member@example.com',NULL);
...
-- Dump completed on 2019-04-20  0:35:05
